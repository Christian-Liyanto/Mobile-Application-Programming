...
public class CustomView extends View {
    static String bentuk = "Path";
    static int warna = Color.rgb(0,0,0);
    Paint paintKu;
    Path pathKu;
    static Canvas kanvasKu;
    Bitmap bitmapKu;
    float pathX, pathY, awalX, awalY, antarX, antarY;
    static final float TOLERANSI_SENTUH = 4;
    boolean clear = false;
